...
var (
	apiResources = map[string][]string{
		...
		types.GroupPowerUser: {
			...
			"POST   /api/workspaces/{workspace_id}/entries/{entry_id}/oauth-credentials/test",
			"POST   /api/workspaces/{workspace_id}/entries/{entry_id}/oauth-credentials/test/status",
		},
